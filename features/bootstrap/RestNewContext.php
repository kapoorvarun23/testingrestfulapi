 ...
 * Features context.
 */
class RestNewContext extends BehatContext
{
    /**
    ...
    /**
     * The request options like User Agent, Auth etc
     */
            ...
            switch ($httpMethod) {
                ...
                case 'POST':
                    $this->requestOptions = array_merge(
                            $this->requestOptions,
                            array('body' => $this->requestPayload)
                        );
                    $this->response = $this
                        ->client
                        ->$method($resource, $this->requestOptions);
                    break;
